<footer class="footer bg-blue-section">
    <div class="inner">
      ...
      <div class="pc-d-fl">
        ...
        <!-- <nav>
          <ul>
            <li id="footer-sitemap-bonus-accordion-triger-btn" class="footer-link-title">BONUS</li>
            <ul id="footer-sitemap-bonus-accordion-list" class="footer-accordion-contents sp-d-none">
        ...
        <!-- <nav>
          <ul>
            <li id="footer-sitemap-guide-accordion-triger-btn" class="footer-link-title">GUIDE</li>
            <ul id="footer-sitemap-guide-accordion-list" class="footer-accordion-contents sp-d-none">
        ...
        <!-- <nav>
          <ul>
            <li id="footer-sitemap-event-accordion-triger-btn" class="footer-link-title">EVENT</li>
            <ul id="footer-sitemap-event-accordion-list" class="footer-accordion-contents sp-d-none">
