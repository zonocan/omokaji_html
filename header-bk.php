          ...
          <li id="pc-header-nav-link-home" class="pc-header-nav-link">
            ...
            <nav id="header-hover-lists-home" class="header-hover-lists d-none">
              <ul>
                ...
                <li><a href="#recomennd"><span>RECOMEND</span></a></li>
    ...
    <nav>
      <ul>
        ...
        <ul id="hum-list-sitemap-home-accordion-list" class="hum-list-accordion-contents d-none">
          ...
          <!-- <li><a href="#guide" class="d-fl"><span>GUIDE</span><small>始め方ガイド</small></a></li> -->
          <!-- <li><a href="#event" class="d-fl"><span>EVENT</span><small>イベント情報</small></a></li> -->
        ...
        <!--  -->
        <!-- <li id="hum-list-sitemap-bonus-accordion-triger-btn" class="hum-list-link-title">BONUS</li> -->
        <!-- <ul id="hum-list-sitemap-bonus-accordion-list" class="hum-list-accordion-contents d-none">
          <li><a href="" class="d-fl"><span>テキストテキストテキスト</span></a></li>
          <li><a href="" class="d-fl"><span>テキストテキストテキストテキストテキ</span></a></li>
          <li><a href="" class="d-fl"><span>テキストテキストテキスト</span></a></li>
        </ul> -->
        <!--  -->        
        ...
        <!--  -->          
        <!-- <li id="hum-list-sitemap-guide-accordion-triger-btn" class="hum-list-link-title">GUIDE</li> -->
        <!-- <ul id="hum-list-sitemap-guide-accordion-list" class="hum-list-accordion-contents d-none">
          <li><a href="" class="d-fl"><span>ベラジョンカジノ</span></a></li>
          <li><a href="" class="d-fl"><span>ミスティーノ</span></a></li>
          <li><a href="" class="d-fl"><span>コニベット</span></a></li>
        </ul> -->
        <!--  -->          
        <!-- <li id="hum-list-sitemap-event-accordion-triger-btn" class="hum-list-link-title">EVENT</li> -->
        <!-- <ul id="hum-list-sitemap-event-accordion-list" class="hum-list-accordion-contents d-none">
          <li><a href="" class="d-fl"><span>テキストテキスト</span></a></li>
          <li><a href="" class="d-fl"><span>テキスト</span></a></li>
          <li><a href="" class="d-fl"><span>テキストテキスト</span></a></li>
        </ul> -->
        <!--  -->          
